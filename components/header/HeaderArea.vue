...
const menuItems = [
  { label: 'Profile', icon: 'uil:user', command: () => console.log('Profile Clicked') },
  { label: 'Settings', icon: 'uil:cog', command: () => console.log('Settings Clicked') },
  { separator: true },
  { label: 'Logout', icon: 'uil:sign-out-alt', command: () => console.log('Logout Clicked') }
]
